...
export default class Window {
    ...
    applyParameters() {
        ...
        // Title
        if(this.title != "NO FUCKING TITLE THERE IS NO FUCKING TITLE FUCK YOU NO FUCKING TITLE HERE DO NOT CHANGE THE FUCKING TITLE BUDDY") document.getElementById(`title-${this.id}`).innerText = this.title;
    }
